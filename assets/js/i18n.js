...
const HK_I18N = {
  ...
  tr: {
    ...
    "order.handoffTitle": "E-posta uygulamanız açıldı",
    "order.handoffBody": "Siparişiniz e-posta taslağı olarak hazırlandı. Taslağı GÖNDERDİKTEN sonra aşağıdaki düğmeyle sepeti boşaltabilirsiniz. Göndermediyseniz sepetiniz olduğu gibi durur.",
    "order.handoffSent": "Gönderdim — sepeti boşalt",
    "order.handoffBack": "Sepete dön",
  ...
  en: {
    ...
    "order.handoffTitle": "Your e-mail app has opened",
    "order.handoffBody": "Your order has been prepared as an e-mail draft. Once you have SENT it, you can empty the basket with the button below. If you did not send it, your basket stays as it is.",
    "order.handoffSent": "I sent it — empty the basket",
    "order.handoffBack": "Back to basket",
  ...
  ru: {
    ...
    "order.handoffTitle": "Открыто ваше почтовое приложение",
    "order.handoffBody": "Ваш заказ подготовлен в виде черновика письма. После ОТПРАВКИ письма вы можете очистить корзину кнопкой ниже. Если вы не отправили письмо, корзина останется без изменений.",
    "order.handoffSent": "Отправлено — очистить корзину",
    "order.handoffBack": "Вернуться в корзину",
