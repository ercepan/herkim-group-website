...
const HK_I18N = {
  ...
  tr: {
    ...
    "f.capTitle": "Doğrulama tamamlanmadı",
    "f.capBody": "Gönderimi tamamlamak için güvenlik doğrulamasını çözmeniz gerekiyor. Formu tekrar gönderip doğrulamayı bitirebilir ya da aşağıdaki yollardan doğrudan bize ulaşabilirsiniz.",
  ...
  en: {
    ...
    "f.capTitle": "Verification not completed",
    "f.capBody": "You need to complete the security check to send the form. Submit again and finish the check, or reach us directly through the options below.",
  ...
  ru: {
    ...
    "f.capTitle": "Проверка не завершена",
    "f.capBody": "Чтобы отправить форму, нужно пройти проверку безопасности. Отправьте форму ещё раз и завершите проверку либо свяжитесь с нами напрямую способами ниже.",
